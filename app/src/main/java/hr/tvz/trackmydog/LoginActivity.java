...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void updateUI(FirebaseUser user) {
        ...
        // TODO (error) set current user in DBFlow
        // .. check if correctly set:
        // TODO - add local user to DBflow, and sing it in:
        ((DbFlowApp) getApplication()).addUser(user.getEmail());
        ...
        hideProgressDialog();
        if (user != null) {
            mStatusTextView.setText(R.string.google_status_fmt);
